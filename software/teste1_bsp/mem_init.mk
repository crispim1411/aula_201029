...
# Memory: onchip_memory2_rc
MEM_0 := aula_201029_qsys_onchip_memory2_rc
$(MEM_0)_NAME := onchip_memory2_rc
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory2_rc
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory2_rc
onchip_memory2_rc: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
