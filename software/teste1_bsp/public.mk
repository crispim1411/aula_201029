...
SOPCINFO_FILE := D:/Users/rosdrigo/Documents/Eng-eletronica/Dispositivos_Reprovaveis/aula_201029/aula_201029_qsys.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios2_qsys_rc
CPU_NAME = nios2_qsys_rc
...
# Design Name 
# setting SOPC_NAME is aula_201029_qsys
SOPC_NAME := aula_201029_qsys
...
# setting hal.stderr is jtag_uart_rc
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_rc

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_rc
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_rc
...
# setting hal.stdout is jtag_uart_rc
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_rc
